...
class Prompt:
    ...
    def get_retrieval_system_prompt(self):
        ...
        Bước 2: Nếu là câu chitchat, hãy trả lời một cách tự nhiên và lễ phép.
        Bước 3: Nếu không phải là câu chitchat, hãy đọc nội dung của văn bản liên quan và lịch sử trò chuyện.
        Bước 4: Nếu đáp án của câu hỏi có trong văn bản liên quan hoặc lịch sử chat, hãy bám sát vào câu hỏi và lịch sử trò chuyện, sau đó trả lời một cách trung thực, chính xác nhất có thể. Lưu ý, câu trả lời nên đưa ra tên của thông tư, điều hoặc nghị định.
